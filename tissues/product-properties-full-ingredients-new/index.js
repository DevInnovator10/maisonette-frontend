...
const FullListIngredientsRevamp = (props) => {
  ...
  return (currentIngredients && currentIngredients.length > 0) ? (
    <ProductPropertyTab title="Full List of Ingredients" product={props.product} revamp>
...
FullListIngredientsRevamp.propTypes = {
  product: PropTypes.object.isRequired
};

export default FullListIngredientsRevamp;
